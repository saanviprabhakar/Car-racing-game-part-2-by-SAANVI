...
{
car2_y = car2_y - 10;
console. log("When up arrow is pressed, w = " + car2_x + " | y = " +car2_y);
uploadBackground();
uploadcar1();
uploadcar2();
}
...
{
car2_y = car2_y + 10;
console. log("When up arrow is pressed, s = " + car2_x + " | y = " +car2_y);
uploadBackground();
uploadcar1();
uploadcar2();
}
...
{
car2_x = car2_x - 10;
console. log("When up arrow is pressed, a = " + car2_x + " | y = " +car2_y);
uploadBackground();
uploadcar1();
uploadcar2();
}
...
{
car2_x = car2_x + 10;
console. log("When up arrow is pressed, d = " + car2_x + " | y = " +car2_y);
uploadBackground();
uploadcar1();
uploadcar2();
}
...
document.getElementById('game_status').innerHTML= "Car 2Won!!";
}
}